<!-- Description -->
## Description
This HelloID Service Automation Delegated Form provides an Active Directory report containing the user accounts that are blocked (disabled or locked). The following options are available:
...
### Powershell data source 'AD-user-generate-table-report-disabled-locked'
...
### Delegated form task 'AD - Report - Blocked accounts (disabled or locked)'
...
## Getting help
_If you need help, feel free to ask questions on our [forum](https://forum.helloid.com/forum/helloid-connectors/service-automation/514-helloid-sa-active-directory-report-ad-accounts-disabled-or-locked)_
