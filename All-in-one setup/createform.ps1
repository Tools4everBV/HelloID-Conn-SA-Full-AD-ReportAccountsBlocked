...
$taskName = "AD-user-generate-table-report-disabled-locked"
$taskGetAdUsersGuid = ""
...
$dataSourceName = "AD-user-generate-table-report-disabled-locked"
...
try {
    ...
    if([string]::IsNullOrEmpty($response.dataSourceGUID)) {
        ...
        $body = @{
            name = "$dataSourceName";
            type = "3";
            model = @(@{key = "CanonicalName"; type = 0}, @{key = "Department"; type = 0}, @{key = "Displayname"; type = 0}, @{key = "Enabled"; type = 0}, @{key = "LockedOut"; type = 0}, @{key = "SamAccountName"; type = 0}, @{key = "Title"; type = 0}, @{key = "UserPrincipalName"; type = 0});
...
$formName = "AD - Report - Blocked accounts (disabled or locked)"
$formGuid = ""
...
try
{
        ...
        [
  {
    ...
    "body": "The following report will show local AD accounts that are blocked or locked. Please wait while the data is loading...",
...
$delegatedFormName = "AD - Report - Blocked accounts (disabled or locked)"
$delegatedFormGuid = ""
...
$taskActionName = "AD-export-report-accounts-disabled-locked"
$taskActionGuid = ""
